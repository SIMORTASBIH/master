            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600">{getPositionLabel(official.position)}</p>
                  <p className="text-sm text-gray-500">
                    {official.branch ? `${official.branch.nama_cabang} (${official.branch.kode_cabang})` : 'Pusat'}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <ul className="text-sm text-red-700 space-y-1">
                    <li>• Data pengurus akan dihapus secara permanen</li>
                    <li>• Riwayat jabatan akan hilang</li>
